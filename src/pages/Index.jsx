...
const Index = () => {
  ...
  const getBotResponse = (message) => {
    ...
    const responses = ["བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ", "བདེ་སྐྱིད་གནང་གོ"];
